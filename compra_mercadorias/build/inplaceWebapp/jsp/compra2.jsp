    ...
    <body>
        ...
        <table style="width:100%">
            ...
            <tr>
                ...
                <td>Lápis</td>
                <td>Faber Castell</td>
                <td><input type="number" placeholder="uni." min="0" max="10"></td>
                <td>R$1,00</td>
            </tr>
        ...
        <p></p>
        <a href="comprar_mercadoria"><button class="button">adicionar compra</button></a>
        <a href="Relatorio_de_Compra"><button class="button">Finalizar compra</button></a>
